...
(function(){
    ...
    for (i=0; i<len; i++){
        (function(script){
            ...
            var refer = windowTop;
            /*
            * For this site we dont know why iframe resizer dosent work if the site contains newsletters
            */
            if(refer.indexOf("www.wellspringgroup.org/newsletters") !== -1) {
                refer = refer.replace("newsletters", "");
            }
